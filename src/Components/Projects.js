    ...
    return (
        <>
            ...
            <div className = "flex justify-center items-center">
                <a  href = "https://github.com/pritamshejul17/premierleague19" target = "_blank" className = "border-r-4 border-white p-10 bg-gray-200">
                    <h1 className = "text-center text-sky-900 text-xl font-medium px-4 pt-4">Premier League 19</h1>
                    <h4 className = "text-center text-sm p-2 text-gray-600">SELF PROJECT</h4>
                    <p className = "p-6 text-gray-800">Application where you can checkout <br/> 
                ...
                <a href =  "https://github.com/pritamshejul17/React-To-Do-App" target = "_blank" className = "border-r-4 border-white p-10 bg-gray-200">
                    <h1 className = "text-center text-sky-900 text-xl font-medium pt-4">To Do's App</h1>
                    <h4 className = "text-center text-sm p-2 text-gray-600">SELF PROJECT</h4>
                    <p className = "p-6 text-gray-800">Application to keep track of your <br/> 
                ...
                <a href =  "https://github.com/pritamshejul17/VS_Clone" target = "_blank" className = " p-10 bg-gray-200" >
                    <h1 className = "text-center text-sky-900 text-xl font-medium px-4 pt-4">VS Clone</h1>
                    <h4 className = "text-center text-sm p-2 text-gray-600">SELF PROJECT</h4>
                    <p className = "p-6 text-gray-800">Created clone of VS code website <br/> 
