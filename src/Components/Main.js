    ...
    return (
        <main className = "flex flex-col items-center sm:items-stretch sm:flex-row sm:justify-evenly mt-6">
            <div className = "flex flex-col justify-center p-12 text-stone-600 order-last">
                ...
                <p className = "text-center p-4 text-lg">Hi I'm <span className = 'font-medium text-sky-700'>Pritam</span> ! I am a software engineer with bachelor's in information<br />technology,
                I am passionate about building web applications <br /> & solving real world problems.</p>
            </div>
